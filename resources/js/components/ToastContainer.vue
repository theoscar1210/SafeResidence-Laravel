        ...
        <div class="pointer-events-none fixed bottom-5 right-5 z-50 flex flex-col gap-2" aria-live="polite">
            ...
            >
                <div
                    ...
                    :key="toast.id"
                    :class="[
                        'pointer-events-auto flex min-w-72 max-w-sm items-start gap-3 rounded-xl border px-4 py-3 shadow-lg',
                        variantClasses[toast.variant],
                    ]"
                >
                    <span :class="['mt-0.5 text-base font-bold leading-none', iconClasses[toast.variant]]">
                        {{ icons[toast.variant] }}
                    </span>
