        ...
        <div class="flex flex-col gap-6 p-6">
            ...
            <div>
                ...
                <p class="text-sm text-muted-foreground">
                    Accesos registrados
                    <span v-if="apartment"> al Apartamento <strong>{{ apartment }}</strong></span>
            ...
            <div class="flex flex-wrap items-end gap-3">
                ...
                <div class="grid gap-1">
                    ...
                    <Input v-model="localFilters.date_from" type="date" class="w-40" />
                </div>
                <div class="grid gap-1">
                    <label class="text-xs font-medium text-muted-foreground">Hasta</label>
                    <Input v-model="localFilters.date_to" type="date" class="w-40" />
                </div>
            </div>
