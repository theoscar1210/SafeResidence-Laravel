    ...
    <AppLayout>
        ...
        <div class="flex flex-col gap-6 p-6">
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div
                    class="rounded-xl border-2 border-primary/20 bg-primary/5 p-5 shadow-sm"
                >
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-4xl font-bold text-primary">
                                {{ stats.inside }}
                            </p>
                        </div>
                ...
                <div class="rounded-xl border bg-card p-5 shadow-sm">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-4xl font-bold text-slate-600">
                                {{ stats.exits_today }}
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p class="text-xs text-green-700">
                                Visitante, propietario o contratista
                            </p>
                        </div>
                    </Link>
                        ...
                        <tr v-if="inside.length === 0">
                            <td colspan="4" class="px-5 py-12 text-center">
                                ...
                                >
                                    ...
                                    <span
                                        >No hay personas dentro del edificio en
                                        este momento.</span
                                    >
                                </div>
                            </td>
